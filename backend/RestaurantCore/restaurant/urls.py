...
from .apis.google_login_api import GoogleLoginAPIView

urlpatterns = [
    path("restaurant/", ListCreateRestaurant.as_view(), name="restaurant-list"),
    path(
        "restaurant/<int:pk>/",
        DetailRestaurantAPIView.as_view(),
        name="restaurant-detail",
    ),
    path(
        "restaurant/<int:pk>/list-menu/",
        MenuAPIView.as_view(),
        name="restaurant-detail",
    ),
    path(
        "restaurant/<int:pk>/list-menu/<int:fk>/",
        DetailMenuAPIView.as_view(),
        name="menu-detail",
    ),
